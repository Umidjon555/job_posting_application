    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'Full-time'), (1, 'Part-time'), (2, 'Intern')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='post.careers')),
            ],
        ),
    ]
